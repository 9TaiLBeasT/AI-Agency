...
export function LampDemo() {
  return (
    <LampContainer>
      ...
      >
        Transform Your Business <br /> with AI Neural
      </motion.div>
      ...
      <motion.p
        ...
        className="mt-8 text-center text-lg text-gray-400 max-w-4xl leading-relaxed"
      >
        Harness the power of cutting-edge artificial intelligence to revolutionize your 
        operations, boost efficiency, and unlock unprecedented growth opportunities.
      </motion.p>
      ...
      >
        ...
        <GradientButton variant="outline" className="px-8 py-4 text-lg">
          Watch Demo
        </GradientButton>
      </motion.div>
    </LampContainer>
