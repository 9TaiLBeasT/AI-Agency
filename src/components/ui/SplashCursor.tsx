...
function step(dt: number) {
    ...
    // Custom color generation for RivRang brand
    function generateColor(): ColorRGB {
      const colors = [
        { r: 0.4, g: 0.2, b: 0.8 }, // Purple
        { r: 0.2, g: 0.6, b: 0.9 }, // Blue
        { r: 0.9, g: 0.4, b: 0.6 }, // Coral/Pink
        { r: 0.3, g: 0.8, b: 0.7 }, // Mint
        { r: 0.7, g: 0.5, b: 0.9 }, // Lavender
      ];
    ...
    // HSVtoRGB function removed as it was unused
